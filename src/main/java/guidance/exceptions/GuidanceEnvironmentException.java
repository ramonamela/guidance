 ...
 *
 */
public class GuidanceEnvironmentException extends Exception {
     ...
     * 
     */
    public GuidanceEnvironmentException() {
        super();
    }
     ...
     * @param msg
     */
    public GuidanceEnvironmentException(String msg) {
        super(msg);
    }
     ...
     * @param e
     */
    public GuidanceEnvironmentException(Exception e) {
        super(e);
    }
     ...
     * @param e
     */
    public GuidanceEnvironmentException(String msg, Exception e) {
        super(msg, e);
    }

...
public class AssocFiles {
	 ...
	 * @param finalStatus
	 */
	public void setSnptestOutFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
	 ...
	 * @param finalStatus
	 */
	public void setSnptestOutMalesFileFinalStatus(int testTypeIndex, int rPanelIndex, int lim1, int lim2, int chunkSize,
			String finalStatus) {
		int index = lim1 / chunkSize;
		this.snptestOutMalesFile.get(testTypeIndex).get(rPanelIndex).get(0).get(index).setFinalStatus(finalStatus);
	}
	 ...
	 * @param finalStatus
	 */
	public void setSnptestOutFemalesFileFinalStatus(int testTypeIndex, int rPanelIndex, int lim1, int lim2,
			int chunkSize, String finalStatus) {
		int index = lim1 / chunkSize;
		this.snptestOutFemalesFile.get(testTypeIndex).get(rPanelIndex).get(0).get(index).setFinalStatus(finalStatus);
	}
	 ...
	 * @return
	 */
	public String getSnptestOutFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize) {
		// Check that chromo index is within the bounds
		checkChromoIndex(chromo);
	 ...
	 * @return
	 */
	public String getSnptestOutMalesFileFinalStatus(int testTypeIndex, int rPanelIndex, int lim1, int lim2,
			int chunkSize) {
		int index = lim1 / chunkSize;
		return this.snptestOutFile.get(testTypeIndex).get(rPanelIndex).get(0).get(index).getFinalStatus();
	}
	 ...
	 * @return
	 */
	public String getSnptestOutFemalesFileFinalStatus(int testTypeIndex, int rPanelIndex, int lim1, int lim2,
			int chunkSize) {
		int index = lim1 / chunkSize;
		return this.snptestOutFile.get(testTypeIndex).get(rPanelIndex).get(0).get(index).getFinalStatus();
	}
	 ...
	 * @param finalStatus
	 */
	public void setSummaryFilteredFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize, String finalStatus) {
	 ...
	 * @return
	 */
	public String getSummaryFilteredFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize) {
		// Check that chromo index is within the bounds
		checkChromoIndex(chromo);
	 ...
	 * @param finalStatus
	 */
	public void setCombinedFilteredFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize, String finalStatus) {
	 ...
	 * @return
	 */
	public String getCombinedFilteredFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize) {
		// Check that chromo index is within the bounds
		checkChromoIndex(chromo);
	 ...
	 * @param finalStatus
	 */
	public void setSummaryCondensedFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize, String finalStatus) {
	 ...
	 * @return
	 */
	public String getSummaryCondensedFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize) {
		// Check that chromo index is within the bounds
		checkChromoIndex(chromo);
	 ...
	 * @param finalStatus
	 */
	public void setCombinedCondensedFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize, String finalStatus) {
	 ...
	 * @return
	 */
	public String getCombinedCondensedFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1,
			int lim2, int chunkSize) {
		// Check that chromo index is within the bounds
		checkChromoIndex(chromo);
	 ...
	 * @param finalStatus
	 */
	public void setSummaryFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize, String finalStatus) {
	 ...
	 * @param finalStatus
	 */
	public void setSummaryMalesFileFinalStatus(int testTypeIndex, int rPanelIndex, int lim1, int lim2, int chunkSize,
			String finalStatus) {
		int index = lim1 / chunkSize;
		this.summaryMalesFile.get(testTypeIndex).get(rPanelIndex).get(0).get(index).setFinalStatus(finalStatus);
	}
	 ...
	 * @param finalStatus
	 */
	public void setSummaryFemalesFileFinalStatus(int testTypeIndex, int rPanelIndex, int lim1, int lim2, int chunkSize,
			String finalStatus) {
		int index = lim1 / chunkSize;
		this.summaryFemalesFile.get(testTypeIndex).get(rPanelIndex).get(0).get(index).setFinalStatus(finalStatus);
	}
	 ...
	 * @return
	 */
	public String getSummaryFileFinalStatus(int testTypeIndex, int rPanelIndex, int chromo, int lim1, int lim2,
			int chunkSize) {
		// Check that chromo index is within the bounds
		checkChromoIndex(chromo);
